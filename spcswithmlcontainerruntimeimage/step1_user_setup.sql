...
spec:
   containers:
   -  name: head
      image: /raydp_sis_db/raydp_sis_core_schema/raydp_sis_image_repo/raydp_head_mlcontainerruntime
      volumeMounts:
      -  name: dshm
         mountPath: /dev/shm
      -  name: raydplogs
...
spec:
   containers:
   -  name: worker
      image: /raydp_sis_db/raydp_sis_core_schema/raydp_sis_image_repo/raydp_worker_mlcontainerruntime
      volumeMounts:
      -  name: dshm
         mountPath: /dev/shm
      -  name: artifacts
...
spec:
   containers:
   -  name: worker
      image: /raydp_sis_db/raydp_sis_core_schema/raydp_sis_image_repo/raydp_custom_worker_mlcontainerruntime
      volumeMounts:
      -  name: dshm
         mountPath: /dev/shm
      -  name: artifacts
